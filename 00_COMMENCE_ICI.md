...
Jean-Yves bascule la **priorité** : moins l’intérieur de l’hôtel, plus **le dehors Dark**.

Ce n’est **pas** un nouveau moteur. C’est le **même FPS** (hôtel / dehors déjà là), le **même** `Barks`, le **même** `Corps.fatigue`, le combat qu’on vient de brancher, et une **carte peinte** qui doit enfin nourrir le sol.
...
**Taille** = [09_TAILLE_DE_LA_CARTE.md](09_TAILLE_DE_LA_CARTE.md) : **10 × 20 km de terre** (pas la mer). Mer autour, très grande. Vol donjon → grotte **5–6 min**, statue Premier-Né en mer.  
